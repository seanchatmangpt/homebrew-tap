class Ggen < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/seanchatmangpt/ggen/releases/download/v26.9.13/ggen-x86_64-apple-darwin.tar.gz"
      sha256 "c09a2653963413595dca625e388dcbc851285cb5740d946bc540a551b383ac60"
    else
